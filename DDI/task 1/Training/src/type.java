...
BufferedReader br=new BufferedReader(new FileReader("Traj.txt")); // This text file contains the XML documents from the DrugBank corpus corresponding to training data set
