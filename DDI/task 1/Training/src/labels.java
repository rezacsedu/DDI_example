...
class array
{
	public static void main(String args[])throws IOException
	{
		try
		{
			...
			int c=0, c1=0;
			String s,s1;
			String arr[]=new String[13962]; // Create a string array to store all the pharmacological substances
			String brr[]=new String[13962]; // Create a string array to store the entity type corresponding to the pharmacological substance
			String crr[]=new String[93463]; // Create a string array to store all the Words
			String drr[]=new String[93463]; // Create a string array that will store the Label of each Word
			...
			for(int i=0; i<13962; i++)
			{
				if(arr[i]!=".")
				{
					for(int j=0; j<93463; j++)
					{
