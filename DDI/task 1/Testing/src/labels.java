...
class array
{
	public static void main(String args[])throws IOException
	{
		try
		{
			...
			int c=0, c1=0;
			String s,s1;
			String arr[]=new String[3650]; // Create a string array to store all the pharmacological substances
			String brr[]=new String[3650]; // Create a string array to store the entity type corresponding to the pharmacological substance
			String crr[]=new String[25423]; // Create a string array to store all the Words
			String drr[]=new String[25423]; // Create a string array that will store the Label of each Word
